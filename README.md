...
<p align="center">
  <a href="https://devtools.at/tools/json-to-typescript"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate TypeScript interfaces from JSON</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/json-to-typescript">Try Online</a> •
...
**[Try JSON to TypeScript online at DevTools.at →](https://devtools.at/tools/json-to-typescript)**
...
Generate TypeScript interfaces from JSON. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/json-to-typescript';
